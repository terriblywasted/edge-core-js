 ...
 */
export interface EdgeWebSocket {
  readonly url: string
  ...
  readonly bufferedAmount: string
...
export interface EdgeIo {
  ...
  readonly WebSocket: EdgeWebSocket
}
...
export interface EdgeCurrencyInfo {
  ...
  displayName: string
  readonly pluginId?: string // Mandatory in next breaking version
...
export interface EdgeSwapInfo {
  ...
  readonly pluginId?: string // Mandatory in next breaking version
  readonly pluginName: string // Deprecated for pluginId
...
export interface EdgeSwapPluginQuote {
  readonly isEstimate?: boolean // Defaults to true. Edge prefers true quotes (not estimates) where possible.
